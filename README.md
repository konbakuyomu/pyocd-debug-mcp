...
通过 [pyOCD](https://pyocd.io/) + CMSIS-DAP 探针，为 Claude / GitHub Copilot 等 AI 工具提供 **44 个调试工具**，涵盖从连接探针、烧录固件、打断点、读寄存器到 HardFault 故障分析的完整调试流程。
...
├── src/pyocd_debug_mcp/
│   ├── server.py               # MCP Server 入口，44 个工具注册
